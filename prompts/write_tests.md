...
3. Write tests in the appropriate location following the project's testing conventions.
4. Tests must compile. Run the project's build check for tests after writing them and fix any errors.
